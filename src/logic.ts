...
export function calculateBaccaratEV(
  counts: DeckCounts, 
  payouts: Payouts, 
  ...
  if (totalCards < 6) {
    return {
      player: { label: 'Player', probability: 0, payout: 0, ev: 0 },
      banker: { label: 'Banker', probability: 0, payout: 0, ev: 0 },
      tie: { label: 'Tie', probability: 0, payout: 0, ev: 0 },
      playerPair: { label: 'P.Pair', probability: 0, payout: 0, ev: 0 },
      bankerPair: { label: 'B.Pair', probability: 0, payout: 0, ev: 0 },
      super6: { label: 'Super6', probability: 0, payout: 0, ev: 0 },
      totalCards
    };
  }
  ...
  const evSuper6 = (tiger6_2_Prob + tiger6_3_Prob) * payouts.super6 - (1 - tiger6_2_Prob - tiger6_3_Prob) + (commission / 2);

  return {
    player: { label: 'Player', probability: pWinProb, payout: payouts.player, ev: evP },
    banker: { label: 'Banker', probability: bWinProb, payout: payouts.banker, ev: evB },
    tie: { label: 'Tie', probability: tieProb, payout: payouts.tie, ev: evT },
    playerPair: { label: 'P.Pair', probability: pPairProb, payout: payouts.playerPair, ev: evPPair },
    bankerPair: { label: 'B.Pair', probability: bPairProb, payout: payouts.bankerPair, ev: evBPair },
    super6: { label: 'Super6', probability: tiger6_2_Prob + tiger6_3_Prob, payout: payouts.super6, ev: evSuper6 },
    totalCards
  };
}
